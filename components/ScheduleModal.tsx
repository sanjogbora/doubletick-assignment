        ...
        <div className="p-6 space-y-5">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <p className="text-[10px] text-green-600 flex items-center gap-1">
                <CheckCircle size={10} /> Agent Free
              </p>
            </div>
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-gray-600 flex items-center gap-1">
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all"
              />
              <p className="text-[10px] text-gray-400">Customer Time: {time} (IST)</p>
            </div>
          </div>
          ...
          <div className="bg-indigo-50/50 rounded-lg p-3 border border-indigo-100">
            <h4 className="text-xs font-bold text-indigo-900 mb-2 flex items-center gap-1.5">
              <Sparkles size={12} className="text-indigo-500" /> AI Prep Checklist
            </h4>
            <div className="space-y-1.5">
              {['Review previous pricing PDF', 'Check inventory for Enterprise Plan', 'Read last 3 emails'].map((item, i) => (
                <label key={i} className="flex items-center gap-2 text-xs text-gray-700 cursor-pointer hover:bg-white/50 p-1 rounded transition-colors">
