...
import { Search, Filter, CheckCircle2, Sparkles, Clock, FileText, AlertCircle } from 'lucide-react';
...
const ChatList: React.FC<ChatListProps> = ({ chats, activeChatId, onSelectChat, chatsWithSuggestions }) => {
  ...
  return (
    <div className="w-full bg-white border-r border-gray-200 flex flex-col h-full flex-shrink-0">
      {/* Header */}
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex gap-1 mt-2 items-center">
                  ...
                  {suggestions && suggestions.length > 0 && (
                    <div className="flex items-center gap-1 px-1.5 py-0.5 bg-purple-50 rounded-md border border-purple-100">
                      ...
                      {suggestions.length > 3 && (
                        <span className="text-[8px] text-purple-600 font-bold">+{suggestions.length - 3}</span>
                      )}
                    </div>
                  )}
                  {chat.unreadCount > 0 && (
