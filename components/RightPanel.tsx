...
import { User, Phone, Mail, Tag, Clock, ChevronDown, Edit2, Save } from 'lucide-react';
    ...
    <div className="w-80 bg-white border-l border-gray-200 flex flex-col h-full hidden lg:block overflow-y-auto">
      ...
      <div className="p-6">
        ...
        <div className="space-y-6">
            ...
            {/* Lead Stage - Dropdown style */}
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
                <div className="flex items-center justify-between mb-1">
                    <span className="text-xs font-semibold text-gray-500 uppercase">Lead Stage</span>
                </div>
                <div className="flex items-center justify-between bg-white border border-gray-200 rounded px-3 py-2 cursor-pointer hover:border-emerald-500 transition-colors">
                    <span className={`text-sm font-medium ${contact.leadStage === LeadStage.HOT ? 'text-red-600' : 'text-gray-700'}`}>
                        {contact.leadStage}
                    </span>
